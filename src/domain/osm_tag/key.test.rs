...
#[test]
fn _05_orders_the_alias_groups_by_priority() {
  assert_eq!(POST_CODE, &[osm_tag::postal_code, osm_tag::addr_postcode]);
  assert_eq!(COUNTRY_ISO, &[osm_tag::iso3166_1, osm_tag::iso3166_1_alpha2]);
}
