...
// encoded up front in the decoder threads: encoding at insert time would move the work into the
// single writer thread and serialise what runs in parallel today
