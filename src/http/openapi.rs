...
#[utoipa::path(
  ...
  responses(
    (status = 200, description = "geocoding result", body = crate::domain::address::query_output),
...
#[openapi(
  ...
  components(schemas(
    crate::domain::address::query_output,
    crate::domain::address::query_service,
    crate::domain::address::query_match,
    crate::domain::address::admin_level,
    crate::domain::address::query_match_attributes,
    crate::domain::address::query_house_number,
    crate::domain::address::house_number_match,
